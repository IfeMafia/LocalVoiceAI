  ...
  return (
    <div className="min-h-screen bg-background flex flex-col text-voxy-text font-sans selection:bg-voxy-primary/30 selection:text-white">
        ...
        <div className="grid gap-6 mb-16">
          {LOGIN_CONTENT.features.map((feature, idx) => (
            <div key={idx} className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-voxy-surface border border-voxy-border flex items-center justify-center shrink-0">
                {feature.icon}
              </div>
              <div>
      ...
      <div className="w-full lg:w-[560px] p-4 sm:p-8 flex flex-col items-center justify-center min-h-screen lg:min-h-0">
        ...
        <div className="w-full max-w-[480px] lg:max-w-none bg-voxy-surface border border-voxy-border rounded-3xl p-6 sm:p-10 shadow-2xl">
          ...
          <Button 
            variant="outline" 
            className="w-full mb-6 bg-background border-voxy-border hover:bg-muted h-11 transition-all"
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-voxy-surface px-3 text-voxy-muted font-medium tracking-wider">Or sign in with email</span>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input 
                  ...
                  className="pl-10 bg-background border-border focus:border-voxy-primary/50 h-11 transition-all" 
                  required 
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input 
                  ...
                  onChange={handleInputChange}
                  placeholder="••••••••" 
                  className="pl-10 pr-10 bg-background border-border focus:border-voxy-primary/50 h-11 transition-all" 
                  required 
                />
                <button 
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-voxy-muted hover:text-voxy-text transition-colors p-1 rounded-md hover:bg-muted"
                >
